...
public class UsuarioServiceTest {
    ...
    // validando todos los correos de los usuario
    @Test
    public void testObtenerEmail() {
        List<UsuarioModel> obtenerUsuarioPorEmail = (List<UsuarioModel>) usuarioRepository.findAll();
        assertThat(obtenerUsuarioPorEmail).size().isGreaterThan(0);
    }

    //validando crreo de cada usuario
    @Test
